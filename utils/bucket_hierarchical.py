...
if __name__ == '__main__':
    h_manager = HierarchicalLabelManager()
    one_depth_length = h_manager.get_output_length(h_manager.one_depth)
    two_depth_length = h_manager.get_output_length(h_manager.two_depth)
    three_depth_length = h_manager.get_output_length(h_manager.three_depth)

    print(h_manager.get_three_depth_index_by_key('접이식테이블'))
    print(h_manager.get_three_depth_index_by_key('트리'))
